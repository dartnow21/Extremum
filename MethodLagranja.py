...
class MethodLagranja:
    def find(self, x, y, x_y, f, z, x_from, x_to, y_from, y_to, left_x_y, ogr):
...
#
        ...
        if (points_max or points_min) and (ogr == 0):
...
functions.find(x, y, x_y, f, f_x_y,  x_from, x_to, y_from, y_to, left_x_y, ogr)
